        ...
        <div>
            <div v-for="episode in episodes" :key="episode.id" class="flex mb-4">
                ...
                <div class="w-3/4 flex flex-col justify-center">
                    ...
                    <div class="mb-1">
                        <router-link class="block truncate no-underline text-black font-bold text-xl" :to="{name:'episodes.show', params:{episodeId:episode.id, podcastId:episode.podcast.id}}">{{ episode.title }}</router-link>
                    </div>
                    <div class="mb-4">
