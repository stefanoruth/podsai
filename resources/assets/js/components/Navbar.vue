    ...
    <div class="bg-white border-t-8 border-orange">
        <nav class="max-w-2xl mx-auto relative select-none md:flex md:items-stretch">
            <div class="flex flex-no-shrink items-stretch">
                <router-link to="/" class="flex-no-grow flex-no-shrink relative p-4 md:p-8 leading-normal text-black text-2xl font-black text-grey-darkest no-underline flex items-center" @click.native="mobileMenu = false">Podsai</router-link>
