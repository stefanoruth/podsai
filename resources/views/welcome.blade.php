...
@section('body')
    <div class="h-screen border-t-4 bg-pattern border-grey p-6 flex justify-center items-center">
        <div class="flex justify-center items-center flex-col max-w-sm">
            ...
            <a href="{{ url('login') }}" class="max-w-xs no-underline px-6 py-4 text-center border-grey bg-grey rounded-lg text-white block hover:border-grey-light hover:bg-grey-light">Continue with Google</a>
        </div>
    </div>
@stop